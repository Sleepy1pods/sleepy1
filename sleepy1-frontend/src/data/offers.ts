...
export const offers: OfferPromo[] = [
  ...
  { id: 'o4', code: 'MONSOON50', title: 'Monsoon Layover Special', description: '₹50 flat off bookings during the monsoon travel season.', discountLabel: '₹50 OFF', validTill: '2026-09-30', segment: 'seasonal' },
]
