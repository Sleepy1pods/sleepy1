...
export const mockWallet: CreditWallet = {
  ...
  transactions: [
    ...
    { id: 'tx2', type: 'redeemed', amount: -650, description: 'Redeemed for Pod 4 · Mumbai T2', date: '2026-06-20', bookingRef: 'SLPY-88213' },
    { id: 'tx3', type: 'promotional', amount: 100, description: 'Welcome bonus credits', date: '2026-05-14' },
    { id: 'tx4', type: 'redeemed', amount: -420, description: 'Redeemed for Pod 8 · Delhi T3', date: '2026-05-12', bookingRef: 'SLPY-77042' },
    { id: 'tx5', type: 'purchased', amount: 250, description: '250 Credits Pack + 15 bonus', date: '2026-04-02' },
    { id: 'tx6', type: 'refunded', amount: 180, description: 'Cancellation refund · Bengaluru T1', date: '2026-03-22', bookingRef: 'SLPY-65590' },
  ],
}
