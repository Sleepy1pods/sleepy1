...
export const mockWallet: CreditWallet = {
  ...
  transactions: [
    ...
    { id: 'tx4', type: 'redeemed', amount: -420, description: 'Redeemed for Pod 8 · IIT Bombay', date: '2026-05-12', bookingRef: 'SLPY-77042' },
    { id: 'tx5', type: 'purchased', amount: 250, description: '250 Credits Pack + 15 bonus', date: '2026-04-02' },
    { id: 'tx6', type: 'refunded', amount: 180, description: 'Cancellation refund · Apollo Hospitals', date: '2026-03-22', bookingRef: 'SLPY-65590' },
  ],
}
