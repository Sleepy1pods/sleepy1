...
export const bookingExtras: BookingExtra[] = [
  ...
  { id: 'extra-coffee', label: 'Coffee Voucher', description: 'Redeemable at any partnered airport café.', price: 99, icon: 'coffee' },
...
export const mockBookings: Booking[] = [
  {
    ...
    locationId: 'loc-bom',
    locationName: 'Mumbai International Airport',
    terminal: 'Terminal 2',
  ...
  },
  {
    ...
    locationId: 'loc-del',
    locationName: 'Delhi International Airport',
    terminal: 'Terminal 3',
